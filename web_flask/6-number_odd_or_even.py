...
def number_odd_or_even(num):
    """
    Route function for the /number_odd_or_even/<n> URL.

    Args:
    num (int): The value of the number variable.

    Returns:
    str: HTML page with H1 tag: "Number: n is even|odd”
    inside the BODY tag.
    """
    odd_or_even = "even" if num % 2 == 0 else "odd"
    return render_template(
            '6-number_odd_or_even.html', num=num, odd_or_even=odd_or_even)
